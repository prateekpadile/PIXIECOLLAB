...
editorSchema.methods.correctPassword = async function(
  candidatePassword,
  userPassword
) {
...
editorSchema.methods.changedPasswordAfter = function(JWTTimestamp) {
...
editorSchema.methods.createPasswordResetToken = function() {
